...
-(void) viewDidLoad
{
      AssetGridThumbnailSize = CGSizeMake(80, 80);
    // _assetRemoveArray = [NSMutableSet new];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section
{
    ...
    NSInteger count =  [_assetArray count];
    return count;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.tag = currentTag;
     ...
     PHAsset *asset =  _assetArray[indexPath.item];
    
    if([_assetRemoveArray containsObject:asset])
    {
        if(!_isNotSelect)
         [cell toggleCheckmark:FALSE];
...
didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AAPLGridViewCell *cell =
    (AAPLGridViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
    ...
    if([_assetRemoveArray containsObject:asset])
    {
         if(!_isNotSelect)
           [cell toggleCheckmark:TRUE];
        [_assetRemoveArray removeObject:asset];
    ...
    else
    {
        ...
        [_assetRemoveArray addObject:asset];
    }
