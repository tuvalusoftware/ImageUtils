...
-(void)setup {
    ...
    _containerView.backgroundColor=BASE_COLOR;
    _anchorContainerView.backgroundColor =BASE_COLOR;
    
    self.reuseCoverContainerView.backgroundColor=BASE_COLOR;
    ...
    self.escapeVelocityThreshold = 3000;
