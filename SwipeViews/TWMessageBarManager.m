...
+ (void)initialize
{
	if (self == [TWDefaultMessageBarStyleSheet class])
	{
        ...
        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor colorWithRed:252.0/255.0 green:79.0/255.0 blue:22.0/255.0  alpha:1];
        
        
        
      
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed:255.0/255.0  green:102.0/255.0 blue:0.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // blue
        
        // Colors (stroke)
        kTWDefaultMessageBarStyleSheetErrorStrokeColor = [UIColor blueColor];
        kTWDefaultMessageBarStyleSheetSuccessStrokeColor = [UIColor blueColor]; // green
        kTWDefaultMessageBarStyleSheetInfoStrokeColor = [UIColor blueColor];
    }
}
